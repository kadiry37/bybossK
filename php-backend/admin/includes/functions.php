...
function generateAIContent($prompt, $type = 'description') {
    ...
    if ($isJson) {
        $systemPrompt = "Sen profesyonel bir SEO içerik yazarısın. Türkçe yaz. Sitenin markası 'DECK Klips'tir ve site yapı/inşaat/dekorasyon sektöründe farklı türde ürünler satmaktadır. İstenen alanları eksiksiz doldurarak SADECE geçerli bir JSON objesi döndür. JSON yapısının dışına asla çıkma, açıklama veya markdown biçimlendirmesi (```json) ekleme. JSON içindeki metin alanlarında Türkçe karakterleri (Ü, Ş, İ, Ç, Ö, Ğ) doğrudan UTF-8 olarak kullan, HTML entity (&#220; vb) yapma. Türkçe dil kurallarına ve teknik terimlere kesinlikle uyun. Hatalı veya uydurma kelimeler kullanmayın; montaj, kurulum, dayanım/dayanıklılık gibi doğru terimleri tercih edin.";
    } else {
        $systemPrompt = "Sen profesyonel bir SEO içerik yazarısın. Türkçe yaz. Sitenin markası 'DECK Klips'tir ve site yapı/inşaat/dekorasyon sektöründe farklı türde ürünler satmaktadır. Sana verilen ürün başlığına odaklan ve SADECE o ürünün ne olduğunu, ne işe yaradığını anlatan profesyonel bir ürün sayfası içeriği üret. Ürünü aşırı övme — bunun yerine ürünü açıklayıcı, bilgilendirici ve tedarikçi/üretici sayfasına yakışır bir dille anlat. Ürün başlığı ile ilgisi olmayan ürünlerden (klips, montaj aparatı vb.) bahsetme; yalnızca verilen ürüne odaklan. Türkçe karakterleri (Ü, Ş, İ, Ç, Ö, Ğ) ASLA HTML entity (&#220; vb) olarak kodlama, her zaman doğrudan UTF-8 karakterlerini kullan. ÖNEMLİ: Türkçe dil kurallarına ve sektörel/teknik terimlere kesinlikle uyun. 'setürme', 'setürülmüş', 'dayanma' (dayanıklılık/dayanım yerine) gibi hatalı veya uydurma kelimeleri KESİNLİKLE kullanmayın; bunun yerine 'kurulum', 'montaj', 'sarılmış', 'hazırlanmış', 'dayanım/dayanıklılık' gibi anlamlı ve doğru Türkçe kelimeler kullanın.";
    }
