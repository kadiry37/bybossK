...
if (isset($_GET['ajax'])) {
    ...
    if ($page === 'ai' && $_POST['action'] === 'ai_generate') {
        ...
        $aiPromptMap = [
            ...
            'all_product' => "Aşağıdaki ürün için profesyonel bir tedarikçi/üretici ürün sayfası içeriği üret. Bu ürünü SATAN bir firma sayfası gibi yaz. \nÖNEMLİ KURALLAR:\n1) Ürünün ne olduğunu ve kullanım alanlarını detaylıca açıkla.\n2) Alakasız ürünlerden bahsetme.\n3) Marka adı olarak sadece 'DECK Klips' yaz.\n4) Yanıtı SADECE geçerli bir JSON olarak ver.\nLÜTFEN AŞAĞIDAKİ ANAHTARLARA SAHİP BİR JSON OLUŞTUR:\n- 'short_description': Kısa özet (max 150 karakter)\n- 'long_description': h2, h3, p etiketleri içeren detaylı HTML içerik (en az 200 kelime)\n- 'specifications': Her satırda 'Özellik: Değer' formatında (örn: Malzeme: Ahşap) tablo verisi\n- 'features': Ürün özelliklerini anlatan akıcı düz yazı\n- 'seo_title': SEO başlığı (max 60 karakter)\n- 'seo_description': Meta açıklama (max 155 karakter)\n- 'seo_keywords': Virgülle ayrılmış 5-8 kelime\nTÜM DEĞERLERİ %100 TÜRKÇE, GERÇEK, UZUN VE DETAYLI METİNLERLE DOLDUR.\nÜrün/Konu: ",
            'blog_all' => "Aşağıdaki blog başlığı/konusu için tam bir blog yazısı içeriği üret. TÜM İÇERİK %100 TÜRKÇE OLMALIDIR (İngilizce kelimeler kullanma). \nÖNEMLİ KURALLAR:\n1) Marka adı olarak sadece 'DECK Klips' yaz.\n2) Yanıtı SADECE geçerli bir JSON olarak ver.\nLÜTFEN AŞAĞIDAKİ ANAHTARLARA SAHİP BİR JSON OLUŞTUR:\n- 'excerpt': Kısa ve ilgi çekici özet (max 150 karakter)\n- 'content': h2, h3, p, strong etiketlerini kullanan detaylı HTML içerik (en az 400 kelime)\n- 'seo_title': SEO başlığı (max 60 karakter)\n- 'seo_description': Meta açıklama (max 155 karakter)\n- 'seo_keywords': Virgülle ayrılmış 5-8 kelime\nTÜM DEĞERLERİ GERÇEK VE UZUN METİNLERLE DOLDUR.\nBlog Konusu: ",
            'all_project' => "Yalnızca sağlanan 'Proje Adı' konusuna odaklanarak profesyonel Türkçe içerik üret. İlgisi olmayan ürünlerden bahsetme. \nÖNEMLİ KURALLAR:\n1) Marka adı olarak sadece 'DECK Klips' yaz.\n2) Yanıtı SADECE geçerli bir JSON olarak ver.\nLÜTFEN AŞAĞIDAKİ ANAHTARLARA SAHİP BİR JSON OLUŞTUR:\n- 'description': h2, h3 ve p etiketleriyle süslenmiş detaylı HTML açıklaması (150-300 kelime)\n- 'seo_title': SEO başlığı (max 60 karakter)\n- 'seo_description': Meta açıklama (max 155 karakter)\n- 'seo_keywords': Virgülle ayrılmış 5-8 kelime\nTÜM DEĞERLERİ %100 TÜRKÇE, GERÇEK VE UZUN METİNLERLE DOLDUR.\nProje Adı: ",
            'all_service' => "Yalnızca sağlanan 'Hizmet Adı' konusuna odaklanarak profesyonel Türkçe içerik üret. Farklı alakasız hizmetler ekleme. \nÖNEMLİ KURALLAR:\n1) Marka adı olarak sadece 'DECK Klips' yaz.\n2) Yanıtı SADECE geçerli bir JSON olarak ver.\nLÜTFEN AŞAĞIDAKİ ANAHTARLARA SAHİP BİR JSON OLUŞTUR:\n- 'short_description': 1-2 cümlelik kısa özet (max 150 karakter)\n- 'long_description': h2, h3 ve p etiketleriyle süslenmiş detaylı HTML açıklama (200-400 kelime)\n- 'seo_title': SEO başlığı (max 60 karakter)\n- 'seo_description': Meta açıklama (max 155 karakter)\n- 'seo_keywords': Virgülle ayrılmış 5-8 kelime\nTÜM DEĞERLERİ %100 TÜRKÇE, GERÇEK VE UZUN METİNLERLE DOLDUR.\nHizmet Adı: "
        ];
