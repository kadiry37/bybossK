...
if (isset($_GET['ajax'])) {
    ...
    if ($page === 'ai' && $_POST['action'] === 'ai_generate') {
        ...
        $aiPromptMap = [
            ...
            'blog_all' => "Aşağıdaki blog başlığı/konusu için tam bir blog yazısı içeriği üret. Asla [Marka Adı] gibi yer tutucular kullanma, marka yazman gerekirse 'DECK Klips' yaz. Yanıtı SADECE geçerli bir JSON olarak ver. İçeriklerde Markdown (**, __) Kesinlikle kullanma. Hiçbir açıklama metni veya markdown (```json) ekleme. JSON Formatı: {\"excerpt\":\"(kısa ve ilgi çekici gerçek özet, maksimum 150 karakter)\",\"content\":\"(h2, h3 ve p etiketlerini kullanan zengin gerçek HTML içerik, en az 400 kelime)\",\"seo_title\":\"(SEO uyumlu başlık, maksimum 60 karakter)\",\"seo_description\":\"(SEO uyumlu meta açıklama, maksimum 155 karakter)\",\"seo_keywords\":\"(virgülle ayrılmış 5-8 kelime)\"}. \n\nBlog Konusu: ",
            'all_project' => "Yalnızca sağlanan 'Proje Adı' konusuna odaklanarak profesyonel içerik üret. Örneğin çatı, pergola veya ahşap işleri ise sadece o konuyu anlat. İlgisi olmayan ürünlerden bahsetme. Asla [Marka Adı] gibi yer tutucular kullanma, marka yazman gerekirse 'DECK Klips' yaz. Yanıtı SADECE geçerli bir JSON olarak ver. İçeriklerde Markdown (**, __) Kesinlikle kullanma. Hiçbir açıklama metni veya markdown (```json) ekleme. JSON Formatı: {\"description\":\"(projenin detaylı gerçek açıklaması, 150-300 kelime)\",\"seo_title\":\"(SEO uyumlu başlık, maksimum 60 karakter)\",\"seo_description\":\"(SEO uyumlu meta açıklama, maksimum 155 karakter)\",\"seo_keywords\":\"(virgülle ayrılmış 5-8 kelime)\"}. \n\nProje Adı: ",
            'all_service' => "Yalnızca sağlanan 'Hizmet Adı' konusuna odaklanarak profesyonel içerik üret. Farklı alakasız ürünler ekleme. Asla [Marka Adı] gibi yer tutucular kullanma, marka yazman gerekirse 'DECK Klips' yaz. Yanıtı SADECE geçerli bir JSON olarak ver. İçeriklerde Markdown (**, __) Kesinlikle kullanma. Hiçbir açıklama metni veya markdown (```json) ekleme. JSON Formatı: {\"short_description\":\"(1-2 cümle kısa gerçek açıklama, maksimum 150 karakter)\",\"long_description\":\"(detaylı gerçek açıklama, 200-400 kelime)\",\"seo_title\":\"(SEO uyumlu başlık, maksimum 60 karakter)\",\"seo_description\":\"(SEO uyumlu meta açıklama, maksimum 155 karakter)\",\"seo_keywords\":\"(virgülle ayrılmış 5-8 kelime)\"}. \n\nHizmet Adı: "
        ];
