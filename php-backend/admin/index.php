...
if (isset($_GET['ajax'])) {
    ...
    if ($page === 'ai' && $_POST['action'] === 'ai_generate') {
        ...
        $aiPromptMap = [
            ...
            'all_product' => "Aşağıdaki ürün için profesyonel bir tedarikçi/üretici ürün sayfası içeriği üret. Bu ürünü SATAN bir firma sayfası gibi yaz. ÖNEMLİ KURALLAR: 1) Ürünü aşırı övme, abartılı pazarlama dili kullanma. 2) Ürünün ne olduğunu, ne işe yaradığını, hangi alanlarda kullanıldığını bilgilendirici şekilde anlat. 3) Ürün başlığı ile ilgisi olmayan ürünlerden (klips, montaj aparatı vb.) bahsetme - yalnızca verilen ürüne odaklan. 4) Asla [Marka Adı] gibi yer tutucular kullanma, marka yazman gerekirse doğrudan 'DECK Klips' yaz. 5) specifications alanı MUTLAKA her satırda 'Özellik: Değer' formatında olmalı (her bir özellik \\n ile ayrılmış, düz paragraf YAZMA). 6) features alanı kesinlikle liste değil, akıcı bir düz yazı (paragraf) olmalı. Yanıtı SADECE geçerli bir JSON olarak ver. İçeriklerde Markdown (**, __, ### gibi) Kesinlikle kullanma, onun yerine sadece temiz HTML etiketleri kullan. Hiçbir açıklama metni veya markdown (```json) ekleme. JSON değerlerini (...) gibi boş veya eksik bırakma, hepsini uzun ve detaylı GERÇEK verilerle doldur. JSON Formatı: {\"short_description\":\"(Tedarikçi sayfasına uygun kısa açıklama, maksimum 150 karakter buraya yazılacak)\",\"long_description\":\"(Ürünün detaylı açıklaması, kullanım alanları, teknik detaylar - EN AZ 150-250 KELİME UZUNLUĞUNDA, HTML formatında h2, h3, p etiketleri kullanan zengin ve bilgilendirici gerçek içerik buraya yazılacak)\",\"specifications\":\"Malzeme: (Gerçek Malzeme)\\nBoyut: (Gerçek Boyut)\\nRenk: (Gerçek Renk)\\n(MUTLAKA her satır Anahtar: Değer formatında, düz paragraf yazma)\",\"features\":\"(Ürünün temel özelliklerini, kalitesini ve kullanım avantajlarını açıklayan akıcı bir düz yazı/paragraf, kesinlikle maddeleme/liste yapma)\",\"seo_title\":\"(SEO uyumlu ürün başlığı, maksimum 60 karakter)\",\"seo_description\":\"(SEO uyumlu meta açıklama, maksimum 155 karakter)\",\"seo_keywords\":\"(virgülle ayrılmış, 5-8 gerçek kelime)\"}. \n\nÜrün/Konu: ",
            'blog_all' => "Aşağıdaki blog başlığı/konusu için tam bir blog yazısı içeriği üret. TÜM İÇERİK %100 TÜRKÇE OLMALIDIR (İngilizce kelimeler kullanma). Asla [Marka Adı] gibi yer tutucular kullanma, marka yazman gerekirse 'DECK Klips' yaz. Yanıtı SADECE geçerli bir JSON olarak ver. Markdown (**, __) Kesinlikle kullanma. JSON Formatı: {\"excerpt\":\"(kısa ve ilgi çekici Türkçe gerçek özet, maksimum 150 karakter)\",\"content\":\"(h2, h3, p, strong etiketlerini kullanan SEO uyumlu, zengin ve uzun Türkçe HTML içerik, en az 400 kelime)\",\"seo_title\":\"(Türkçe SEO uyumlu başlık, maksimum 60 karakter)\",\"seo_description\":\"(Türkçe SEO uyumlu meta açıklama, maksimum 155 karakter)\",\"seo_keywords\":\"(virgülle ayrılmış 5-8 Türkçe kelime)\"}. \n\nBlog Konusu: ",
            'all_project' => "Yalnızca sağlanan 'Proje Adı' konusuna odaklanarak profesyonel Türkçe içerik üret. Örneğin çatı, pergola veya ahşap işleri ise sadece o konuyu anlat. İlgisi olmayan ürünlerden bahsetme. Asla [Marka Adı] gibi yer tutucular kullanma, marka yazman gerekirse 'DECK Klips' yaz. Yanıtı SADECE geçerli bir JSON olarak ver. Markdown (**, __) Kesinlikle kullanma. JSON Formatı: {\"description\":\"(projenin h2, h3 ve p etiketleriyle süslenmiş detaylı Türkçe HTML açıklaması, 150-300 kelime)\",\"seo_title\":\"(Türkçe SEO uyumlu başlık, maksimum 60 karakter)\",\"seo_description\":\"(Türkçe SEO uyumlu meta açıklama, maksimum 155 karakter)\",\"seo_keywords\":\"(virgülle ayrılmış 5-8 Türkçe kelime)\"}. \n\nProje Adı: ",
            'all_service' => "Yalnızca sağlanan 'Hizmet Adı' konusuna odaklanarak profesyonel Türkçe içerik üret. Farklı alakasız ürünler ekleme. Asla [Marka Adı] gibi yer tutucular kullanma, marka yazman gerekirse 'DECK Klips' yaz. Yanıtı SADECE geçerli bir JSON olarak ver. Markdown (**, __) Kesinlikle kullanma. JSON Formatı: {\"short_description\":\"(1-2 cümle kısa Türkçe gerçek açıklama, maksimum 150 karakter)\",\"long_description\":\"(h2, h3 ve p etiketleriyle süslenmiş detaylı Türkçe HTML açıklama, 200-400 kelime)\",\"seo_title\":\"(Türkçe SEO uyumlu başlık, maksimum 60 karakter)\",\"seo_description\":\"(Türkçe SEO uyumlu meta açıklama, maksimum 155 karakter)\",\"seo_keywords\":\"(virgülle ayrılmış 5-8 Türkçe kelime)\"}. \n\nHizmet Adı: "
        ];
